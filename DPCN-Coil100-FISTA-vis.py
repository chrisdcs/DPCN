...
save_dir = ROOT / "runs" / "FISTA" / "coil100"
...
layer1 = Layer_FISTA_vis(n_ch=3, lam=0., gamma0=.1, mu=0.001, beta=0.1, X_dim=1000, U_dim=128, patch_size=16, 
...
for epoch in range(max_epochs):
    ...
    if (epoch+1) % 1 == 0:
        torch.save(layer1.state_dict(), save_dir / f"layer1_vis_{epoch+1}.pth.tar")
