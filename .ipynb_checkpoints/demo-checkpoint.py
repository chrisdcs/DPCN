...
opt_A = torch.optim.Adam(layer1.A.parameters(), lr=1e-3)
...
for epoch in range(max_epochs):
    ...
    for _, data in enumerate(loader):
        ...
        for t in range(X.shape[-1]):
            ...
            state_recon_loss = Correntropy(predicted_state-xt, layer1.sigma_t)#layer1.lam * F.huber_loss(predicted_state, xt, delta=0.01)#Correntropy(predicted_state-xt, layer1.sigma_t)
