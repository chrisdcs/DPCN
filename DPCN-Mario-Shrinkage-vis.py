...
save_dir = ROOT / "runs" / "shrinkage" / "mario"
...
layer1 = Shrinkage_Layer_Mario_vis(n_ch=3, lam=.5, gamma0=0.2, mu=0.3, beta=0.2, n_u=50)
...
torch.save(layer1.state_dict(), save_dir / "layer1_vis.pth.tar")